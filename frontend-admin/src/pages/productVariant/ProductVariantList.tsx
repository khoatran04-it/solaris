                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                <th className="w-[24%] py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider text-left">Thông Tin Biến Thể</th>
                                        ...
                                        <tr key={item.id} className="hover:bg-slate-50/80 transition-colors duration-200 group">
                                            ...
                                            <td className="py-3 px-6">
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <div className="flex flex-col">
                                                        <span className="font-extrabold text-slate-800 text-[14px] leading-tight truncate max-w-56" title={item.name}>{item.name}</span>
                                                        <div className="flex items-center gap-2 mt-1.5">
                                                            <span className="text-[10px] font-bold bg-blue-50 text-blue-700 px-1.5 py-0.5 rounded border border-blue-200/50 uppercase tracking-widest">{item.code}</span>
                                                            {item.prices?.length > 1 && (
                                                                <span className="text-[10px] font-medium text-slate-500 bg-slate-100 px-1.5 py-0.5 rounded">+{item.prices.length - 1} UoM</span>
                                                            )}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <td className="py-3 px-2">
                                                {defaultPriceInfo ? (
                                                        ...
                                                        {isDiscounted ? (
                                                            <>
                                                                <div className="flex items-baseline gap-1.5">
                                                                    ...
                                                                    <span className="text-[11px] text-slate-400 font-medium">/ {defaultPriceInfo.uoMName}</span>
                                                    ...
                                                    <span className="text-xs italic text-amber-500 bg-amber-50 px-2 py-1 rounded border border-amber-200/50">Chưa cài giá</span>
                                                )}
                                            </td>
