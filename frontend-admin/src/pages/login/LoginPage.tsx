...
const LoginPage = () => {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setError(serverMsg || (err.message === 'Network Error' ? 'Không thể kết nối đến máy chủ backend (Network Error).' : 'Đăng nhập thất bại. Vui lòng kiểm tra lại tài khoản hoặc mật khẩu!'));
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center font-sans overflow-hidden bg-slate-900">
            ...
            <div className="absolute inset-0 z-0">
                ...
                <div className="absolute bottom-[-20%] right-[-10%] w-140 h-140 bg-amber-400/20 rounded-full mix-blend-screen filter blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
            ...
            <div className="relative z-10 w-full max-w-105 p-6">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-black tracking-[0.2em] text-white italic">
                        SOLARIS
                    </h1>
