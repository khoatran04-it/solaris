                    ...
                    <table className="w-full text-left border-collapse min-w-[950px]">
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                ...
                                <th className="w-[16%] py-4 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider">Người Nhận</th>
                                ...
                                issues.map((issue) => (
                                    <tr key={issue.id} className="hover:bg-slate-50/80 transition-colors duration-200 group">
                                        ...
                                        <td className="py-3 px-2">
                                            <div className="text-[13px] font-bold text-slate-800">{issue.warehouseName}</div>
                                        </td>
