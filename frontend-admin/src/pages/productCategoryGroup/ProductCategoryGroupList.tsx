...
const ProductCategoryGroupList: React.FC = () => {
    ...
    const [deletingRecord, setDeletingRecord] = useState<ProductCategoryGroup | null>(null);
    ...
    const fetchData = async () => {
        setIsLoading(true);
        try {
            const response = await productCategoryGroupApi.getAll({
                                        ...
                                        <td className="py-3 px-6">
                                            <div className="flex items-center gap-3.5">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="font-extrabold text-slate-800 text-[14px] truncate max-w-64 leading-tight">{item.name}</span>
                                                    <div className="flex items-center gap-2 mt-1.5">
                                                        ...
                                                        {item.description && (
                                                            <span className="text-[11px] font-medium text-slate-500 truncate max-w-48" title={item.description}>
                                                                {item.description}
                                                            </span>
                                                        )}
                                                    </div>
