  ...
  return (
    <PageContainer>
      ...
      <FormHeader
        ...
        subtitle={
          isEditMode
            ? 'Cập nhật thông tin phân loại hàng hóa cấp cao nhất'
            : 'Tạo mới một cấu trúc nhóm ngành hàng vào hệ thống'
        }
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-10">
          ...
          <FormSection title="Thông Tin Cơ Bản">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <FormInput
                label="Tên Nhóm"
                required
                placeholder="VD: Nông Sản Tươi Sống"
                value={formData.name}
                error={errors.name}
                disabled={loading}
          ...
          <FormSection title="Hình Ảnh & Mô Tả">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormTextarea
                label="Mô tả nhóm ngành hàng"
                placeholder="Nhập chi tiết mô tả..."
