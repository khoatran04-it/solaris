                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                <th className="w-[25%] py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider text-left">Thông Tin Kho</th>
                                ...
                                <th className="w-[15%] py-4 px-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
                                    <CustomFilter title="KHU VỰC (TỈNH/THÀNH)" options={provinceOptions} selectedValues={provinceFilter} onApply={setProvinceFilter} />
                                </th>
                        ...
                        <tbody className="divide-y divide-slate-100">
                            {isLoading ? (
                                        ...
                                        <tr key={item.id} className="hover:bg-slate-50/80 transition-colors duration-200 group">
                                            ...
                                            <td className="py-3 px-6">
                                                <div className="flex flex-col">
                                                    <span className="font-extrabold text-slate-800 text-[14px] leading-tight truncate max-w-56" title={item.name}>
                                                        {item.name}
                                                    </span>
                                            ...
                                            <td className="py-3 px-2">
                                                <div className="flex items-start gap-1.5">
                                                    ...
                                                    <span className="text-[12px] font-medium text-slate-600 line-clamp-2 pr-4" title={item.fullAddress}>
                                                        {item.fullAddress}
                                                    </span>
                                                </div>
                                            </td>
                                            ...
                                            <td className="py-3 px-2">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    {item.managerName ? (
                                                        <span className="text-[13px] font-bold text-slate-700">{item.managerName}</span>
                                                    ) : (
                                ...
                                <TableEmpty colSpan={6} message="Thử thay đổi từ khóa tìm kiếm hoặc bộ lọc khu vực." />
                            )}
                        </tbody>
                    </table>
                </div>
