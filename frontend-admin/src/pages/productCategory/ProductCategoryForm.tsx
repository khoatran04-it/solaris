...
const ProductCategoryForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([productCategoryGroupApi.getAllList(), productCategoryApi.getAllList()])
  ...
  return (
    <PageContainer>
      ...
      <FormHeader
        ...
        subtitle={
          isEditMode
            ? 'Cập nhật thông tin phân loại chi tiết của hàng hóa'
            : 'Tạo mới một danh mục con vào hệ thống'
        }
          ...
          <FormSection title="Hình Ảnh & Mô Tả">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <FormTextarea
                ...
                placeholder="Nhập chi tiết mô tả danh mục..."
