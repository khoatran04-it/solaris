...
import { Edit3, Trash2, FolderTree, Image as ImageIcon } from 'lucide-react';
                  ...
                  >
                    ...
                    <td className="py-3 px-2">
                      {item.categoryGroupName ? (
                        <span
                          className="inline-flex px-2.5 py-1 rounded-lg text-xs font-semibold bg-violet-50 text-violet-700 border border-violet-200/60 truncate max-w-full"
