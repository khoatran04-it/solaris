...
const SupplierDetail: React.FC = () => {
  ...
  const fetchSupplierProducts = () => {
    ...
    supplierProductApi
      .getBySupplierId(Number(id), false)
  ...
  return (
    <DetailPageContainer>
      ...
      <ConfirmDeleteModal
        ...
        itemName={
          deletingType === 'address'
            ? 'địa chỉ kho này'
            : deletingProductRecord?.variantName || 'sản phẩm này'
        }
      ...
      <DetailHeader
        ...
        subtitle={
          <>
            Mã hệ thống: <span className="text-slate-800 font-bold">{supplier.code}</span>
          </>
        }
      ...
      <TabGroup>
        ...
        <TabButton
          ...
          label={`SẢN PHẨM & BẢNG GIÁ (${supplierProducts.length})`}
          icon={Package}
        />
        <TabButton
          ...
          <div className="p-8 grid grid-cols-1 lg:grid-cols-3 gap-10 items-start">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-8">
                  ...
                  <InfoField
                    ...
                    value={
                      <span className="inline-flex px-2.5 py-0.5 rounded-lg bg-indigo-50 text-indigo-700 text-xs font-bold border border-indigo-200/30">
                        {supplier.supplierTypeName || 'Chưa cập nhật'}
                      </span>
                    }
                  />
                  ...
                  <div className="md:col-span-2 grid grid-cols-2 border-l-2 border-slate-100 pl-4 py-0.5 gap-2 mt-2">
                    <div className="flex flex-col items-start">
                      ...
                      <DateTimeCell isoString={supplier.createdAt} />
                    </div>
                    <div className="flex flex-col items-start">
                      <span className="text-[11px] font-bold text-slate-400 uppercase mb-1">
                        Cập Nhật Gần Nhất
                      </span>
                      <DateTimeCell isoString={supplier.updatedAt} />
                    </div>
                  </div>
                </div>
              </DetailSection>
                ...
                <p className="text-sm text-slate-600 leading-relaxed bg-slate-50/70 p-4 rounded-2xl border border-slate-100 min-h-24">
                  {supplier.note || (
                    <span className="italic text-slate-400 font-normal">
                      Không có ghi chú đặc biệt cho nhà cung cấp này.
                    </span>
                  )}
                </p>
              </DetailSection>
            ...
            <div className="lg:col-span-1">
              <DetailProfileCard
                ...
                statusActive={supplier.isActive}
              />
            </div>
          </div>
        )}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Danh mục các mặt hàng được phép nhập từ nhà cung cấp này kèm giá tham chiếu và MOQ
                </p>
              </div>
              <button
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/70 border-b border-slate-100">
                    ...
                    <th className="w-[15%] py-4 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-left">
                      Mã SKU NCC
                    </th>
                    <th className="w-[15%] py-4 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">
                      Đơn Giá Nhập
                    </th>
                ...
                <tbody className="divide-y divide-slate-100">
                  {productsLoading ? (
                    ...
                    <TableEmpty
                      colSpan={7}
                      message="Nhà cung cấp này chưa có sản phẩm nào trong bảng giá."
                    />
                  )}
                </tbody>
              </table>
          ...
          <div className="p-8 flex flex-col gap-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-slate-500 mt-1">
                  Quản lý các địa điểm lấy hàng, trả hàng của đối tác
                </p>
              </div>
              <button
              ...
              <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-slate-100">
                  {supplier.addresses && supplier.addresses.length > 0 ? (
                    ...
                    <TableEmpty
                      colSpan={5}
                      message="Nhà cung cấp này chưa có dữ liệu địa chỉ kho."
                    />
                  )}
                </tbody>
              </table>
