...
const UoMCategoryForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    Promise.all([uomCategoryApi.getAllList(), uomApi.getAllList()])
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-10">
          ...
          <FormSection title="Cấu Hình Hệ Thống">
            ...
            <p className="mt-2 text-xs text-slate-500 italic">
              * Lưu ý: Đơn vị gốc (Base UoM) dùng làm trạm trung chuyển để tính toán hệ số. Bạn có
              thể thiết lập sau khi đã tạo xong các Đơn vị tính con.
            </p>
          </FormSection>
