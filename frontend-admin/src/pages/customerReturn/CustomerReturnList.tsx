                    ...
                    <table className="w-full text-left border-collapse min-w-275">
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                ...
                                <th className="w-[10%] py-4 px-2 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">Tiền Hoàn</th>
                        ...
                        <tbody className="divide-y divide-slate-100 text-sm">
                            {loading ? (
                                ...
                                returns.map((ret, idx) => (
                                    <tr key={ret.id} className="hover:bg-slate-50/80 transition-colors duration-200 group">
                                        {/* CELL 1: # */}
                                        ...
                                        <td className="px-4 py-3.5 text-center">
                                            <div className="flex justify-center">
                                                <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-bold border shadow-sm ${CustomerReturnStatusColors[ret.status]}`}>
