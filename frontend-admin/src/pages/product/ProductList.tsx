...
const ProductList: React.FC = () => {
    ...
    }, [currentPage, debouncedSearch, categoryFilter, uomFilter, statusFilter, createdAtFilter, updatedAtFilter]);
                        ...
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                ...
                                <th className="w-[14%] py-4 px-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
                                    <CustomFilter title="DANH MỤC" options={categoryOptions} selectedValues={categoryFilter} onApply={setCategoryFilter} />
                                </th>

                                <th className="w-[12%] py-4 px-2 text-xs font-bold text-slate-500 uppercase tracking-wider">
                                    <CustomFilter title="ĐƠN VỊ TÍNH" options={uomOptions} selectedValues={uomFilter} onApply={setUomFilter} />
                                </th>
                                ...
                                data.map((item) => (
                                    <tr key={item.id} className="hover:bg-slate-50/80 transition-colors duration-200 group">
                                        ...
                                        <td className="py-3 px-6">
                                            <div className="flex items-center gap-3.5">
                                                ...
                                                <div className="flex flex-col">
                                                    <span className="font-extrabold text-slate-800 text-[14px] truncate max-w-56 leading-tight">{item.name}</span>
                                                    <div className="flex items-center gap-2 mt-1.5">
                                                        <span className="text-[10px] font-bold bg-slate-800 text-white px-1.5 py-0.5 rounded shadow-sm uppercase tracking-widest">{item.code}</span>
                                                        {item.description && (
                                        ...
                                        <td className="py-3 px-2">
                                            {item.categoryName ? (
                                                <span className="inline-flex px-2 py-1 rounded-md text-[11px] font-bold bg-blue-50 text-blue-700 border border-blue-200/60 truncate max-w-full" title={item.categoryName}>
                                                    {item.categoryName}
                                                </span>
                                            ) : (
