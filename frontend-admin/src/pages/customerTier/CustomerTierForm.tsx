  ...
  return (
    <PageContainer>
      ...
      <FormHeader
        ...
        subtitle={
          isEditMode
            ? 'Cập nhật thông tin chính sách bậc khách hàng'
            : 'Thiết lập chính sách bậc khách hàng và chiết khấu mới'
        }
          ...
          <FormSection title="Thông Tin Cơ Bản">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
              <FormInput
                label="Mã phân bậc"
                required
                placeholder="VANG, BAC, KIM CUONG..."
                value={formData.code}
                error={errors.code}
                disabled={loading}
              ...
              <FormInput
                label="Tên phân bậc"
                required
                placeholder="Ví dụ: Khách hàng Vàng"
                value={formData.name}
                error={errors.name}
                disabled={loading}
