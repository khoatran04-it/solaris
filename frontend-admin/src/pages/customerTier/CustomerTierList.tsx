                    ...
                    <table className="w-full text-left border-collapse min-w-240">
                        <thead>
                            <tr className="bg-slate-50/70 border-b border-slate-100">
                                ...
                                <th className="w-[18%] py-4 px-6 text-xs font-bold text-slate-500 uppercase tracking-wider text-left">Tên Phân Bậc</th>
                                <th className="w-[10%] py-4 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-center">Chiết Khấu</th>
                                <th className="w-[16%] py-4 px-4 text-xs font-bold text-slate-500 uppercase tracking-wider text-right">Chi tiêu tối thiểu</th>
