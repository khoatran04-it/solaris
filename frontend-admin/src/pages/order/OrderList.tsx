  ...
  useEffect(() => {
    const loadOptions = async () => {
      try {
        ...
        setCustomerOptions(
          custRes.map((c: any) => ({ label: `${c.code} - ${c.name}`, value: c.id }))
        );
                ...
                orders.map((order) => (
                  ...
                  >
                    ...
                    <td className="py-3 px-2 text-center">
                      <div className="flex justify-center">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold border shadow-sm ${OrderStatusColors[order.status]}`}
                        >
                    ...
                    <td className="py-3 px-2 text-center">
                      <div className="flex justify-center">
                        <span
                          className={`inline-flex items-center px-2.5 py-1 rounded-full text-[11px] font-bold border shadow-sm ${PaymentStatusColors[order.paymentStatus]}`}
                        >
