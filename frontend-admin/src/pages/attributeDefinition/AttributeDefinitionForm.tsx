...
const DATA_TYPE_OPTIONS = [
  ...
  {
    label: 'Chọn sẵn (OPTIONS) - Thường dùng cho Nguồn gốc (VietGAP, Organic)...',
    value: 'OPTIONS',
  },
];
  ...
  return (
    <PageContainer>
      ...
      <FormHeader
        ...
        subtitle={
          isEditMode
            ? 'Cập nhật chuẩn mực thuộc tính cho sản phẩm'
            : 'Định nghĩa một tiêu chuẩn mới (VD: VietGAP, Khay 500g...) vào hệ thống'
        }
