...
export const PurchaseOrderStatusColors: Record<PurchaseOrderStatus, string> = {
  [PurchaseOrderStatus.Draft]: 'bg-slate-100 text-slate-600 border-slate-200',
  [PurchaseOrderStatus.Processing]: 'bg-blue-100 text-blue-700 border-blue-200',
  [PurchaseOrderStatus.Approved]: 'bg-emerald-100 text-emerald-700 border-emerald-200',
  [PurchaseOrderStatus.PartiallyReceived]: 'bg-amber-100 text-amber-700 border-amber-200',
  [PurchaseOrderStatus.Completed]: 'bg-green-100 text-green-800 border-green-200',
  [PurchaseOrderStatus.Cancelled]: 'bg-red-100 text-red-700 border-red-200',
};
