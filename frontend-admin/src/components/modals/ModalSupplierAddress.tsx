...
export const ModalSupplierAddress: React.FC<ModalSupplierAddressProps> = ({ 
    ...
    const validateForm = () => {
        ...
        if (!formData.contactName.trim()) newErrors.contactName = 'Vui lòng nhập tên người liên hệ kho.';
                ...
                <div className="p-6">
                    <form id="addressForm" onSubmit={handleSubmit} className="flex flex-col gap-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <FormInput 
                                label="Người liên hệ tại kho" required placeholder="Nguyễn Văn B..."
                                value={formData.contactName} error={errors.contactName} disabled={isSubmitting}
                                onChange={e => handleFieldChange('contactName', e.target.value)} 
                            />
                            <FormInput 
                                label="Số điện thoại kho" required placeholder="09..."
                                value={formData.contactPhone} error={errors.contactPhone} disabled={isSubmitting}
                        ...
                        <FormInput 
                            label="Địa chỉ chi tiết (Số nhà, đường)" required placeholder="Số 12, Lê Duẩn..."
                        ...
                        <div className="flex items-center gap-3 mt-2 bg-slate-50 p-4 rounded-xl border border-slate-100">
                            ...
                            <div className="flex flex-col">
                                <span className="text-[13px] font-bold text-slate-700">Đặt làm địa chỉ lấy hàng mặc định</span>
                                <span className="text-[11px] text-slate-500">Hệ thống sẽ ưu tiên kho này khi tạo đơn nhập hàng (PO).</span>
                            </div>
                        </div>
