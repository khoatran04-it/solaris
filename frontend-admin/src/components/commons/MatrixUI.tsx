                    ...
                    <div key={module} className="bg-white border border-slate-200 rounded-xl overflow-hidden shadow-sm">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <h3 className="font-bold text-slate-700 uppercase tracking-wide text-[13px]">{module}</h3>
                            </div>
                            <button type="button" className="flex items-center gap-2 text-[12px] font-bold text-slate-500">
                                {isAllSelected ? (
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex flex-col">
                                            <span className={`text-[13.5px] font-bold leading-tight ${isChecked ? 'text-emerald-800' : 'text-slate-700'}`}>
                                                {perm.name}
                                            </span>
