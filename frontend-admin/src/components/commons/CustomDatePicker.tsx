...
const DatePicker: React.FC<DatePickerProps> = ({ 
    label, required, error, value, onChange, placeholder = "Chọn ngày/tháng/năm..." 
}) => {
    ...
    const displayValue = value ? value.toLocaleDateString('vi-VN', { day: '2-digit', month: '2-digit', year: 'numeric' }) : '';
    ...
    return (
        <div ref={wrapperRef} className="flex flex-col relative w-full">
            ...
            >
                ...
                <CalendarIcon size={18} className={`transition-colors duration-300 ${isOpen ? "text-yellow-500" : "text-slate-400"}`} />
            </div>
