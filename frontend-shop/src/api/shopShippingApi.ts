...
import { GhnProvince, GhnDistrict, GhnWard, GhnCalculateFeePayload, GhnCalculateFeeResponse } from '@/types/shipping';

const shopShippingApi = {
    getProvinces: () =>
        axiosClient.get<GhnProvince[]>('/shipping/provinces'),
    ...
    calculateFee: (payload: GhnCalculateFeePayload) =>
        axiosClient.post<GhnCalculateFeeResponse>('/shipping/calculate-fee', payload),
};
