...
import { ShopCustomerProfile, ShopCustomerProfileUpdatePayload, ShopAddress, ShopAddressPayload } from '@/types/customer';

const shopCustomerApi = {
    getProfile: () =>
        axiosClient.get<ShopCustomerProfile>('/customer/profile'),

    updateProfile: (data: ShopCustomerProfileUpdatePayload) =>
        axiosClient.put<ShopCustomerProfile>('/customer/profile', data),

    getAddresses: () =>
        axiosClient.get<ShopAddress[]>('/customer/addresses'),
