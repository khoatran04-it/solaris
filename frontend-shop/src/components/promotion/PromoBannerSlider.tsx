      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="space-y-4 max-w-xl text-center md:text-left">
          ...
          <p className="text-xs sm:text-sm text-emerald-100/90 leading-relaxed font-medium">
            Nông sản tươi thu hoạch từ các nông trại công nghệ cao Đà Lạt, bảo
            quản nhiệt độ chuẩn 2-8°C và giao nhanh trong 2 giờ.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 pt-2">
            ...
            <div className="flex items-center gap-1.5 text-xs text-emerald-100 font-bold bg-white/10 px-4 py-3 rounded-2xl backdrop-blur-xs border border-white/15">
              ...
              <span>
                Giảm ngay{" "}
                {activePromo.isPercentage
                  ? `${activePromo.discountValue}%`
                  : `${activePromo.discountValue}đ`}
              </span>
            </div>
          </div>
        </div>
