...
import { MapPin, Award, ArrowRight, Sprout } from 'lucide-react';
        ...
        <div className="bg-white rounded-2xl border border-slate-200/80 p-3 shadow-2xs hover:shadow-md hover:border-emerald-300 transition-all flex gap-3 items-center">
            ...
            <div className="flex-1 min-w-0 space-y-1">
                ...
                <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-[10px] text-slate-400 font-medium">/{product.uoMName || 'Kg'}</span>
                </div>
            </div>
            ...
            <Link
                ...
                className="w-7 h-7 rounded-full bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white transition-all flex items-center justify-center shrink-0 shadow-2xs"
                title="Xem chi tiết"
            >
