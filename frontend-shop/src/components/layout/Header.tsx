            ...
            <div className="bg-gradient-to-r from-emerald-700 via-emerald-600 to-teal-700 text-white text-[11px] py-1.5 px-4 font-semibold tracking-wide">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="hidden sm:inline-block">Nông sản sạch từ nông trại đến bàn ăn — Cam kết hoàn tiền / đổi trả trong 24h</span>
                    ...
                    <div className="flex items-center gap-4 text-emerald-100">
                        ...
                        <a href="tel:19008888" className="flex items-center gap-1 text-white hover:text-amber-200 transition-colors font-bold">
                    ...
                    <div className="flex items-center gap-2 sm:gap-3">
                        ...
                        >
                            ...
                            <div className="hidden lg:flex flex-col text-left leading-none">
                                <span className="text-[10px] text-slate-400 font-bold uppercase">Giỏ hàng</span>
                                ...
                                {isUserMenuOpen && (
                                    ...
                                    >
                                        <div className="px-4 py-3 border-b border-slate-100 bg-slate-50/50">
                                            <p className="text-[11px] text-slate-400 font-medium">Tài khoản thành viên</p>
                                ...
                                <div className="absolute left-0 top-full hidden group-hover:block w-56 bg-white shadow-[0_10px_30px_-5px_rgba(0,0,0,0.12)] rounded-2xl border border-slate-100 py-2.5 z-50 animate-in fade-in duration-150">
                                    ...
                                    {group.categories.map((cat) => (
                                        ...
                                        >
                                            ...
                                            <span className="text-[10px] text-slate-400 font-normal">{cat.productCount}</span>
                                        </Link>
                                    ))}
                                </div>
                            )}
            ...
            {isMenuOpen && (
                <div className="md:hidden border-t border-slate-200 bg-white p-5 space-y-5 animate-in slide-in-from-top-2 duration-200">
                    ...
                    <div className="space-y-1">
                        <div className="text-[10px] font-bold text-slate-400 uppercase px-2 mb-1">Danh Mục Nông Sản</div>
                        <Link 
                            href="/san-pham" 
                        ...
                        {categories.map((group) => (
                            ...
                            >
                                <span>{group.groupName}</span>
                                <span className="text-[10px] text-slate-400 font-medium">{group.categories.length} loại</span>
                            </Link>
                        ))}
                        <Link 
                            href="/khuyen-mai" 
                    ...
                    {isAuthenticated && user && (
                        <div className="border-t border-slate-100 pt-3 space-y-1">
                            <div className="text-[10px] font-bold text-slate-400 uppercase px-2 mb-1">Tài Khoản Của Tôi</div>
                            <Link 
                                href="/tai-khoan" 
                                onClick={() => setIsMenuOpen(false)}
