...
export default function GioHangPage() {
    ...
    const hasItems = (cart && cart.items && cart.items.length > 0) || (guestItems && guestItems.length > 0);
            ...
            <div className="flex items-center justify-between pb-5 border-b border-slate-200">
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1 font-medium">
                        Bạn đang có <strong className="text-emerald-700">{totalCount} món hàng</strong> trong giỏ
                    </p>
                </div>
                        ...
                        <div className="bg-white rounded-3xl border border-slate-200/80 shadow-[0_2px_20px_-4px_rgba(0,0,0,0.04)] p-6 sm:p-7 space-y-5">
                            ...
                            <div className="space-y-3 text-xs">
                                ...
                                <div className="pt-4 border-t border-slate-100 flex justify-between items-baseline">
                                    ...
                                    <span className="font-black text-2xl text-emerald-800">{formatVND(cart.estimatedTotal)}</span>
                                </div>
                            </div>
