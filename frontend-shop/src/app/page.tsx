            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center max-w-2xl mx-auto space-y-2 mb-10">
                    ...
                    <p className="text-xs sm:text-sm text-slate-500">
                        Phân loại rõ ràng theo chuẩn an toàn thực phẩm VietGAP, GlobalGAP & nguồn gốc vùng trồng
                    </p>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 sm:gap-5">
                    {categories.map((group) => {
                        const count = group.categories.reduce((sum, c) => sum + c.productCount, 0);
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-200">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Ưu Đãi Hôm Nay</h2>
                                <p className="text-xs text-slate-500 mt-0.5">Giảm giá hấp dẫn các mặt hàng vụ mùa thu hoạch tươi mới</p>
                            </div>
                        </div>
                ...
                <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between mb-8 pb-4 border-b border-slate-200">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl sm:text-2xl font-black text-slate-900 tracking-tight">Mới Về Hôm Nay</h2>
                                <p className="text-xs text-slate-500 mt-0.5">Thu hoạch sáng sớm từ các nông trường công nghệ cao Đà Lạt</p>
                            </div>
                        </div>
                ...
                <div className="bg-gradient-to-br from-emerald-900 via-emerald-800 to-teal-900 rounded-3xl p-8 sm:p-12 text-white shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-10 items-center relative overflow-hidden">
                    ...
                    <div className="lg:col-span-5 bg-white text-slate-900 rounded-3xl p-7 sm:p-8 space-y-5 text-center shadow-xl relative z-10">
                        ...
                        <div className="space-y-1.5">
                            <h3 className="text-lg font-black text-slate-900">Bạn là Nông Hộ hoặc Khách Hàng B2B?</h3>
                            <p className="text-xs text-slate-500 leading-relaxed">
                                Hợp tác cùng chuỗi cung ứng Solaris để đưa nông sản sạch chất lượng cao đến hàng triệu gia đình.
                            </p>
                        </div>
                        <Link
                            href="/san-pham"
