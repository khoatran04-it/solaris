                    ...
                    <div className="lg:col-span-3 space-y-4">
                        {isLoading ? (
                            ...
                            ordersResult.items.map((order) => (
                                <div
                                    key={order.id}
                                    className="bg-white rounded-2xl border border-slate-100 shadow-sm hover:border-emerald-200 transition-all space-y-4 p-6"
                                >
                                    ...
                                    <div className="flex items-center justify-between pt-2">
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center gap-1.5 px-4 py-2 bg-slate-50 hover:bg-emerald-50 text-emerald-600 hover:text-emerald-700 font-semibold text-xs rounded-xl transition-colors"
                                        >
