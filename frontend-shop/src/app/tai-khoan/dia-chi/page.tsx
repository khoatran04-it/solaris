            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-8">
                ...
                <div>
                    ...
                    <p className="text-xs text-slate-500 mt-1 font-medium">
                        Quản lý danh sách địa chỉ giao hàng để đặt mua nông sản nhanh chóng hơn
                    </p>
                </div>
                            ...
                            <div className="bg-white rounded-3xl shadow-[0_4px_25px_-5px_rgba(0,0,0,0.05)] border border-slate-200/80 p-6 sm:p-8 space-y-5 animate-in fade-in">
                                ...
                                <form onSubmit={handleAddAddress} className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                                        <label className="font-extrabold text-xs text-slate-700 uppercase tracking-wide block">Họ tên người nhận *</label>
                                        <input
                                            type="text"
                                            value={receiverName}
                                    ...
                                    <div className="space-y-1 sm:col-span-2">
                                        <label className="font-extrabold text-xs text-slate-700 uppercase tracking-wide block">Địa chỉ cụ thể (Số nhà, tên đường) *</label>
                                        <input
                                            type="text"
