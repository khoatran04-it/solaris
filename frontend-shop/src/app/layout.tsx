...
export const metadata: Metadata = {
  ...
  description:
    "Solaris Farm cung cấp rau củ quả, trái cây tươi sạch trực tiếp từ nông trại Đà Lạt đến bàn ăn. Giao nhanh 2h, bảo toàn độ tươi giòn, truy xuất nguồn gốc minh bạch.",
  keywords: [
    "nông sản sạch",
    "trái cây nhập khẩu",
    "rau củ đà lạt",
  ...
  openGraph: {
    ...
    description:
      "Phân phối nông sản tươi ngon, an toàn từ nông trại công nghệ cao.",
  },
  robots: {
    index: true,
    follow: true,
