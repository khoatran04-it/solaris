...
export default async function DanhMucOverviewPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
            {/* 1. Header Banner */}
            <div className="bg-gradient-to-br from-emerald-800 via-emerald-700 to-teal-800 rounded-3xl p-8 sm:p-12 text-white shadow-xl relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-2xl space-y-4">
                    ...
                    <div className="flex items-center gap-4 pt-2 text-xs font-semibold text-emerald-200">
