        ...
        <div className="max-w-md w-full bg-white rounded-3xl shadow-[0_2px_20px_-4px_rgba(0,0,0,0.05)] border border-slate-100 p-8 space-y-6">
            ...
            <form onSubmit={handleLogin} className="space-y-4">
                <div className="space-y-1.5">
                    <label className="font-bold text-[13px] text-slate-700 uppercase tracking-wide mb-2 block">Tên đăng nhập hoặc SĐT</label>
                ...
                <div className="space-y-1.5">
                    <label className="font-bold text-[13px] text-slate-700 uppercase tracking-wide mb-2 block">Mật khẩu</label>
                    <div className="relative">
                        <input
                            type="password"
                            placeholder="••••••••"
            ...
            <div className="text-center pt-2 border-t border-slate-100 text-xs text-slate-600 space-y-2">
                <p>
                    Chưa có tài khoản?{' '}
                    <Link href={`/dang-ky?redirect=${encodeURIComponent(redirectUrl)}`} className="text-emerald-600 hover:text-emerald-700 font-semibold">
                        Đăng ký miễn phí
                    </Link>
                </p>
            </div>
