...
namespace backend.Migrations
{
    ...
    [Migration("20260923121240_AddInventoryTransferApprovalFields")]
    partial class AddInventoryTransferApprovalFields
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend.Models.DeliveryTrip", b =>
                {
                    ...
                    b.ToTable("DeliveryTrips", (string)null);
                });

            modelBuilder.Entity("backend.Models.DeliveryTripOrder", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DeliveryTripOrders", (string)null);
                });

            modelBuilder.Entity("backend.Models.DeliveryVehicle", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("HomeWarehouseId")
                        .HasColumnType("int");

                    b.Property<bool>("IsActive")
                        .HasColumnType("bit");

                    b.Property<bool>("IsColdChainEquipped")
                        .HasColumnType("bit");
                    ...
                    b.ToTable("DeliveryVehicles", (string)null);
                });
            ...
            modelBuilder.Entity("backend.Models.SupplierProductPriceHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend.Models.UoMConversion", b =>
                {
                    ...
                    b.HasIndex("ProductId", "FromUoMId", "ToUoMId")
                        .IsUnique()
                        .HasFilter("[ProductId] IS NOT NULL AND [FromUoMId] IS NOT NULL AND [ToUoMId] IS NOT NULL");
            ...
            modelBuilder.Entity("backend.Models.Warehouse", b =>
                {
                    ...
                    b.Property<double>("MaxColdChainRadiusKm")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
            ...
            modelBuilder.Entity("backend.Models.DeliveryTrip", b =>
                {
                    ...
                    b.HasOne("backend.Models.DeliveryVehicle", "Vehicle")
                        .WithMany("Trips")
            ...
            modelBuilder.Entity("backend.Models.DeliveryTripOrder", b =>
                {
                    ...
                    b.HasOne("backend.Models.DeliveryTrip", "Trip")
                        .WithMany("TripOrders")
            ...
            modelBuilder.Entity("backend.Models.DeliveryVehicle", b =>
                {
                    b.HasOne("backend.Models.Warehouse", "HomeWarehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.InventoryTransfer", b =>
                {
                    ...
                    b.HasOne("backend.Models.IAUser", "InspectedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("backend.Models.SupplierProductPriceHistory", b =>
                {
                    ...
                    b.HasOne("backend.Models.SupplierProduct", "SupplierProduct")
                        .WithMany()
