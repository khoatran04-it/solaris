    ...
    public class ShopProductProfile : Profile
    {
        public ShopProductProfile()
        {
            ...
            CreateMap<PromotionCampaign, ShopPromotionBadgeDto>()
                .ForMember(dest => dest.Slug, opt => opt.MapFrom(src => src.Slug ?? src.Id.ToString()));
            #endregion
            ...
            CreateMap<ProductCategoryGroup, ShopCategoryTreeDto>()
                ...
                .ForMember(dest => dest.GroupSlug, opt => opt.MapFrom(src => src.Slug ?? src.Id.ToString()))
            ...
            CreateMap<ProductCategory, ShopCategoryItemDto>()
                ...
                .ForMember(dest => dest.CategorySlug, opt => opt.MapFrom(src => src.Slug ?? src.Id.ToString()))
